...
module Ds
  class Application < Hanami::Application
    configure do
      ...
      #
      # sessions :cookie, secret: ENV['DS_SESSIONS_SECRET']
      ...
      #
      layout :application # It will load Ds::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time Ds::Action is included
      ...
      # Configure the code that will yield each time Ds::View is included
      # This is useful for sharing common functionality
      #
      # See: http://www.rubydoc.info/gems/hanami-view#Configuration
      view.prepare do
        include Hanami::Helpers
        include Ds::Assets::Helpers
      end
    end
